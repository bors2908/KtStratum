...
public interface MessageTransport {
     ...
     *
     * @throws IOException If the transport connection fails for any reason, such as an interrupted connection or any
     ...
     *
     * @param message The request message to send.
     * @param responseType The type of response expected for the request.
     *
     * @throws IOException If the transport connection fails for any reason, such as an interrupted connection or any
     * other type of unexpected connection drop-out or failure.
     */
     ...
     * transport.
     *
     * @param listener The listener that will be notified when requests are received.
     */
     ...
     * transport.
     *
     * @param listener The listener that will no longer be notified when requests are received.
     */
     ...
     * transport.
     *
     * @param listener The listener that will be notified when one or more responses are received.
     */
     ...
     * transport.
     *
     * @param listener The listener that will no longer be notified when responses are received.
     */
    void unregisterResponseListener(MessageListener<ResponseMessage> listener);

    void registerNotificationListener(MessageListener<NotificationMessage> listener);

    void unregisterNotificationListener(MessageListener<NotificationMessage> listener);
}
