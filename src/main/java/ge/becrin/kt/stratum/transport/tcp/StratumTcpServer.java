...
public abstract class StratumTcpServer {
     ...
     *
     * @param connectionSocket The socket for which a connection is desired.
     *
     ...
     *
     * @param connection The connection being accepted.
     */
     ...
     *
     * @param connection The connection for which the timer is being reset.
     *
     * @throws IllegalArgumentException If the connection is not known to this server.
     */
     ...
     * method being called again.
     *
     * @param connectionId The unique identifier for the connection for which the timer is being reset.
     *
     * @throws IllegalArgumentException If the connection is not known to this server.
     */
    @SuppressWarnings("UnstableApiUsage")
     ...
     *
     * @param connection The connection that has timed-out.
     */
