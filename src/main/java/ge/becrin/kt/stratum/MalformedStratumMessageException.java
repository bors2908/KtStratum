...
public class MalformedStratumMessageException
     ...
     * malformed.
     *
     * @param jsonMessage The JSON message that is malformed.
     */
     ...
     * malformed.
     *
     * @param jsonMessage The JSON message that is malformed, as a JSON {@code String}.
     */
     ...
     *
     * @param jsonMessage The JSON message that is malformed.
     * @param error A description of the problem with the message.
     */
     ...
     *
     * @param jsonMessage The JSON message that is malformed.
     * @param t The exception that occurred while processing the message.
     */
     ...
     *
     * @param method The name of the method that was being interpreted.
     * @param jsonMessage The JSON message that is malformed.
     */
