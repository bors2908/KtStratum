...
public abstract class Message {
     ...
     * the request does not expect a response.</p>
     *
     * @param id Sets the unique identifier for the message. This may be {@code null}.
     */
     ...
     *
     * @param jsonMessage The message that was parsed.
     *
     * @throws MalformedStratumMessageException If the data parsed into this object from the provided message was incorrect for the type of
